use crate::learners::{collection_type, compound_data_type, control_flow, enum_type, error_handling, function, ownership, primary_data_type, shadowing, struct_data_type};
...
fn main() {
    ...
    collection_type::learn_collection();
}
